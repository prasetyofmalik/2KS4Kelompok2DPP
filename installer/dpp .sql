...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 26, 2022 at 02:52 PM
...
CREATE TABLE `perusahaan` (
  ...
  `namaKab` varchar(100) NOT NULL,
  `periodeData` int(100) NOT NULL,
  `no` int(100) NOT NULL,
  `kodeProv` varchar(100) NOT NULL,
  `kodeKab` varchar(100) NOT NULL,
  `kodeKec` varchar(100) NOT NULL,
  `kodeKJU` varchar(100) NOT NULL,
  `noUrutKab` int(100) NOT NULL,
  ...
  `konfirm` int(100) NOT NULL,
  `status` int(100) NOT NULL,
  `tanamanPangan` varchar(100) NOT NULL,
  `holtikultura` varchar(100) NOT NULL,
  `perkebunan` varchar(100) NOT NULL,
  `peternakan` varchar(100) NOT NULL,
  `kehutanan` varchar(100) NOT NULL,
  `perikanan` varchar(100) NOT NULL,
  `inputUsahaUtama` varchar(100) NOT NULL
...
INSERT INTO `perusahaan` (`namaProv`, `namaKab`, `periodeData`, `no`, `kodeProv`, `kodeKab`, `kodeKec`, `kodeKJU`, `noUrutKab`, `namaPerusahaan`, `alamatPerusahaan`, `noTelp`, `noFax`, `kode`, `konfirm`, `status`, `tanamanPangan`, `holtikultura`, `perkebunan`, `peternakan`, `kehutanan`, `perikanan`, `inputUsahaUtama`) VALUES
('DKI JAKARTA', 'KOTA JAKARTA PUSAT', 2020, 1, '31', '73', '123', '1', 1, 'Perusahaan Tanaman Hidup', 'Jalan. Sehat', '0812927313', '021382382', 3, 0, 4, '1', '1', '0', '1', '0', '0', '1'),
('DKI JAKARTA', 'KOTA JAKARTA PUSAT', 2020, 2, '31', '73', '124', '2', 2, 'Perusahaan Hidup Sejahtera', 'Jalan. Sejahtera', '0823829373', '021821812', 7, 1, 7, '1', '0', '0', '1', '1', '1', '2'),
('KALIMANTAN SELATAN', 'KABUPATEN BANJAR', 2022, 1, '63', '03', '123', '1', 40, 'Perusahaan Bersama', 'Jalan Kehidupan', '08962873827', '0318399273', 2, 1, 8, '1', '0', '1', '0', '1', '0', '1'),
('JAWA TENGAH', 'KABUPATEN PURWOREJO', 2022, 1, '33', '06', '165', '2', 17, 'Perusahaan Hidup Mati', 'Jalan di situ', '08927293823', '0318332993', 8, 0, 8, '1', '1', '1', '1', '0', '0', '2'),
('JAWA TENGAH', 'KABUPATEN PURWOREJO', 2022, 1, '33', '06', '123', '4', 14, 'Perusahaan Kekuatan', 'Jalan ya ndak tau', '0892738937', '0213883823', 5, 0, 5, '1', '1', '1', '0', '0', '1', '4'),
('DKI JAKARTA', 'KOTA JAKARTA TIMUR', 2020, 1, '31', '72', '123', '5', 15, 'Perusahaan Makmur', 'Jalan Jatinegara', '08968656853', '0217885574', 5, 0, 1, '0', '0', '1', '0', '0', '0', '5'),
('DKI JAKARTA', 'KOTA JAKARTA TIMUR', 2020, 2, '31', '72', '145', '6', 16, 'Perusahaan Hore', 'Jalan Otista', '08928373722', '0218228337', 7, 1, 4, '0', '0', '0', '0', '1', '0', '6');
...
INSERT INTO `user` (`userID`, `name`, `email`, `username`, `password`, `jumlahEntri`) VALUES
(1, 'Jekz', 'jekz@gmail.com', 'jekz', 'jekz', 3),
(3, 'Fito', 'fito@gmail.com', 'fito', 'fito', 2),
(4, 'tioo ni bos', 'tiogaming@gmail.com', 'tio', 'tio', 0),
(6, 'hasanah', 'hasanah@gmail.com', 'hasanah', 'hasanah', 0),
(7, 'Kelompok 2', 'kelompok2', 'kel2', 'kel2', 2),
(8, 'Oldy', 'oldygais@gmail.com', 'oldy', 'oldy', 0);
